...
export var BTabs = /*#__PURE__*/Vue.extend({
  ...
  watch: (_watch = {}, _defineProperty(_watch, MODEL_PROP_NAME, function (newValue, oldValue) {
    ...
    if (!looseEqual(newValue.map(function (t) {
      return t[COMPONENT_UID_KEY];
    }), oldValue.map(function (t) {
      return t[COMPONENT_UID_KEY];
    }))) {
  ...
  methods: {
    ...
    updateTabs: function updateTabs() {
      var $tabs = this.getTabs(); // Normalize `currentTab`

      var currentTab = this.currentTab;
      var $tab = $tabs[currentTab];

      if (!$tab || $tab.disabled) {
        currentTab = $tabs.indexOf($tabs.slice().reverse().find(function ($tab) {
